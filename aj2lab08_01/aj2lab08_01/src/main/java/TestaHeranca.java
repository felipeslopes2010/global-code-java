...
public class TestaHeranca {
    ...
    public static void main(String args[]) {
        ...
        ContaEspecial contaEsp1 = new ContaEspecial(5, "1", cliente1, ag1, 10); // 1a. conta especial
        
        ContaEspecial contaEsp2 = new ContaEspecial(100, "1", cliente1, ag1, 10); // 2a. conta especial
        
        ContaPoupanca contaPoup = new ContaPoupanca(300, "2", cliente2, ag1,"18/10/2018"); // conta poupanca
